...
const reactionstype = {
    ...
    'тык': { endpoint: 'poke', text: 'тыкнул(а)' },
    'cry': { endpoint: 'cry', text: 'is crying' },
    'подмигнуть': { endpoint: 'wink', text: 'подмигнул(а)' },
    'smile': { endpoint: 'smile', text: 'smiled at' },
    'wave': { endpoint: 'wave', text: 'waved at' },
    'blush': { endpoint: 'blush', text: 'is blushing' },
    'танцевать': { endpoint: 'dance', text: 'танцует вместе с' },
    'cuddle': { endpoint: 'cuddle', text: 'cuddled' },
    'шлепнуть': { endpoint: 'slap', text: 'шлепает ->' },
    'пнуть': { endpoint: 'kick', text: 'пинает ->' },
