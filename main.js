...
// --- Enhanced logging (colors & detailed info) ---
const chalk = require('chalk');
// ensure basic ANSI support
chalk.level = 1;
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        // Detailed logging for messages and commands
        try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.unban'):
                ...
                break;
            case userMessage === '.help' || userMessage === '.menu' || userMessage === '.меню' || userMessage === '.команды':
            ...
            case userMessage === '.tagnotadmin':
                ...
                break;
            case userMessage === '.hidetag' || userMessage === '.вызов' || userMessage === '.все':
                {
